-- Check Datatypes for numeric data
-- Check datatypes used to generate Order_date in the Orders table
-- and Start_date in the Employee table
-- Check the manner in which Comments are added!  Same as in Oracle
-- Date format is yyyy-mm-dd
-- Check by SELECT CURRENT_DATE
...
CREATE TABLE salgrade (
 ...
 low_salary          NUMERIC(6,2) NOT NULL,
 high_salary         NUMERIC(6,2) NOT NULL);
...
CREATE TABLE employee (
 ...
 manager             SMALLINT(6),
 salary              NUMERIC(6,2)  NOT NULL   CHECK (salary < 9999 ),
 department_nr       SMALLINT(2)    NOT NULL,
...
INSERT INTO employee VALUES (1000,'King','J.R.','M',CURRENT_DATE-558,'Chairman',NULL,5000,10);
INSERT INTO employee VALUES (1036,'Blake','S.T.','M',CURRENT_DATE-465,'Manager',1000,2850,30);
INSERT INTO employee VALUES (1023,'Clark','M.','F',CURRENT_DATE-372,'Manager',1000,2450,10);
INSERT INTO employee VALUES (1024,'Jones','D.S.','M',CURRENT_DATE-279,'Manager',1000,2975,20);
INSERT INTO employee VALUES (1035,'Martin','R.J.','M',CURRENT_DATE-341,'Salesman',1036,1250,30);
INSERT INTO employee VALUES (1033,'Allen','P.G.','F',CURRENT_DATE-465,'Salesman',1023,2000,10);
INSERT INTO employee VALUES (1007,'Turner','J.','M',CURRENT_DATE-31,'Salesman',1036,1500,30);
INSERT INTO employee VALUES (1019,'Jameson','N.H.B.','F',CURRENT_DATE-434,'Clerk',1036,950,30);
INSERT INTO employee VALUES (1013,'Ward','K.T.','M',CURRENT_DATE-217,'Salesman',1024,1250,20);
INSERT INTO employee VALUES (1026,'Ford',NULL,'M',CURRENT_DATE-527,'Analyst',1023,3000,10);
INSERT INTO employee VALUES (1029,'Smith','J.','M',CURRENT_DATE-496,'Clerk',1036,800,30);
INSERT INTO employee VALUES (1022,'Scott','B.L.','F',CURRENT_DATE-248,'Analyst',1024,3000,20);
INSERT INTO employee VALUES (1017,'Adams','G.D.C','F',CURRENT_DATE,'Clerk',1023,1100,10);
INSERT INTO employee VALUES (1030,'Miller',NULL,'F',CURRENT_DATE-155,'Clerk',1024,1300,20);
...
INSERT INTO orders VALUES (1000,'MW97',1317,CURRENT_DATE-570,100);
INSERT INTO orders VALUES (1001,'HD12',1674,CURRENT_DATE-529,5);
INSERT INTO orders VALUES (1002,'DS96',1443,CURRENT_DATE-524,150);
INSERT INTO orders VALUES (1003,'MW97',1674,CURRENT_DATE-466,75);
INSERT INTO orders VALUES (1004,'HD12',1317,CURRENT_DATE-442,5);
INSERT INTO orders VALUES (1005,'MW97',1543,CURRENT_DATE-440,100);
INSERT INTO orders VALUES (1006,'TX10',1087,CURRENT_DATE-394,25);
INSERT INTO orders VALUES (1007,'AM17',1019,CURRENT_DATE-366,5);
INSERT INTO orders VALUES (1008,'XM21',1674,CURRENT_DATE-334,10);
INSERT INTO orders VALUES (1009,'HD12',1223,CURRENT_DATE-291,125);
INSERT INTO orders VALUES (1010,'GD2',1036,CURRENT_DATE-257,100);
INSERT INTO orders VALUES (1011,'DS96',1674,CURRENT_DATE-257,50);
INSERT INTO orders VALUES (1012,'TX10',1036,CURRENT_DATE-224,5);
INSERT INTO orders VALUES (1013,'MW97',1223,CURRENT_DATE-207,10);
INSERT INTO orders VALUES (1014,'HD12',1036,CURRENT_DATE-197,100);
INSERT INTO orders VALUES (1015,'AM17',1443,CURRENT_DATE-169,50);
INSERT INTO orders VALUES (1016,'DS96',1317,CURRENT_DATE-162,25);
INSERT INTO orders VALUES (1017,'HD12',1543,CURRENT_DATE-128,10);
INSERT INTO orders VALUES (1018,'GD2',1443,CURRENT_DATE-110,5);
INSERT INTO orders VALUES (1019,'MW97',1019,CURRENT_DATE-83,25);
INSERT INTO orders VALUES (1020,'XM21',1223,CURRENT_DATE-63,5);
INSERT INTO orders VALUES (1021,'GD2',1087,CURRENT_DATE-49,125);
INSERT INTO orders VALUES (1022,'DS96',1674,CURRENT_DATE,100);
INSERT INTO orders VALUES (1023,'HD12',1443,CURRENT_DATE,10);
...
CREATE TABLE prospect (
 ...
 post_code           CHAR(8),
 telephone           VARCHAR(15),
 credit_rating       SMALLINT(2)    NOT NULL   CHECK (credit_rating between 0 and 20),
